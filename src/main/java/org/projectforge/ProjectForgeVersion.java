...
public class ProjectForgeVersion
{
  ...
  public static final Version VERSION = new Version("4.1.4.14b1");

  public static final String NUMBER = VERSION.toString();

  public static final String RELEASE_DATE = "2012-12-01";

  public static final String RELEASE_TIMESTAMP = "2012-12-01 01:50";
}
