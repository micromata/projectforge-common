...
public class ProjectForgeVersion
{
  ...
  public static final String VERSION_STRING = "5.3";

  public static final String RELEASE_DATE = "2013-12-30";

  public static final String RELEASE_TIMESTAMP = "2013-12-30 10:46";
