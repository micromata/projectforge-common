...
public class ProjectForgeVersion
{
  ...
  public static final String VERSION_STRING = "5.2";

  public static final String RELEASE_DATE = "2013-07-06";

  public static final String RELEASE_TIMESTAMP = "2013-07-06 08:30";
